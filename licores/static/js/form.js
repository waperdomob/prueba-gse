...
function formatRepo(repo) {
    ...
    var option = $(
        ...
        '<b>Codigo:</b> ' + repo.idDrink + '<br>' +
        '<b>Nombre:</b> ' + repo.strDrink + '<br>' +
        '<b>Tags :</b> ' + repo.strTags + '<br>' +
        '<b>Categoria :</b> ' + repo.strCategory + '<br>' +
        '<b>Tipo de baso :</b> ' + repo.strGlass + '<br>' +
        '<b>Instrucciones:</b> <span class="badge badge-warning">' + repo.strInstructions + '</span>' +
        '</p>' +
        '</div>' +
        '</div>' +
        '</div>');
